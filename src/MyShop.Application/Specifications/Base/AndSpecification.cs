...
/// <summary>
/// Represents the logical AND composition of two specifications.
/// Combines criteria using AND logic and merges include expressions from both specifications.
/// </summary>
/// <typeparam name="TEntity">The entity type.</typeparam>
/// <remarks>
/// <para>
/// This specification is created by the <see cref="SpecificationExtensions.And{TEntity}"/> extension method.
/// </para>
/// <para>
/// <strong>Criteria Combination:</strong> If both specifications have criteria, they are combined using AND logic.
